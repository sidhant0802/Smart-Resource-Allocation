...
// ═══════════════════════════════════════════════════════════
// Send task notification to multiple volunteers (new task created)
// ═══════════════════════════════════════════════════════════
      ...
      const html = `
        ...
        <head>
          ...
          <style>
            * { margin:0; padding:0; box-sizing:border-box; }
            ...
            .info-box label { font-size:11px; color:#9ca3af; text-transform:uppercase; letter-spacing:0.5px; display:block; margin-bottom:4px; }
            .info-box p { font-size:18px; font-weight:700; color:#1f2937; margin:0; }
        ...
        <body>
          <div class="container">
            <div class="card">
              <div class="header">
                <h1 style="margin:0;font-size:24px;">🆕 New Task Available!</h1>
                <p style="margin:8px 0 0;opacity:0.9;font-size:14px;">A new volunteer opportunity is waiting for you</p>
              </div>
              <div class="body">
                <h2 style="margin:0 0 12px;color:#1f2937;font-size:22px;">${task.title}</h2>
...
// ═══════════════════════════════════════════════════════════
// Send task assignment confirmation (volunteer approved by committee)
// ═══════════════════════════════════════════════════════════
    ...
    const html = `
      ...
      <body>
        <div class="container">
          <div class="card">
            <div class="header">
              <h1 style="margin:0;font-size:24px;">✅ You've Been Approved!</h1>
              <p style="margin:8px 0 0;opacity:0.9;font-size:14px;">Your task application has been accepted</p>
            </div>
            <div class="body">
